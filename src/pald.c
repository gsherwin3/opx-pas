...
/* EXTREME_HACK address in snapcraft_vm.yaml static char PAS_CONFIG_FILENAME_DFLT[] = "/etc/opx/pas/config.xml"; */
static char PAS_CONFIG_FILENAME_DFLT[] = "/vendor/dell/s6000/etc/opx/pas/config.xml";
